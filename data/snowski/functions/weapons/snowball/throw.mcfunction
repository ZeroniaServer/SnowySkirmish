...
execute as @e[type=snowball,tag=GreenBall,tag=!ThrownBall] at @s run summon arrow ~ ~ ~ {Tags:["SBArrow","GreenArrow"],Team:["Green"],inGround:0b,OnGround:0b}
execute as @e[type=snowball,tag=RedBall,tag=!ThrownBall] at @s run summon arrow ~ ~ ~ {Tags:["SBArrow","RedArrow"],Team:["Red"],inGround:0b,OnGround:0b}
