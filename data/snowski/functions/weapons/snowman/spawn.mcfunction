...
execute as @e[tag=SpawnRedSnowman] at @s run summon armor_stand ~ ~ ~ {Silent:1b,NoGravity:0b,Team:"Red",ArmorItems:[{},{},{},{id:"golden_hoe",Count:1b,tag:{Unbreakable:1b,CustomModelData:11}}],Tags:["RedSnowman","Snowman","NewSnowman"],Invisible:1b,Invulnerable:1b,DisabledSlots:2096896,Rotation:[-90f,0f]}
execute as @e[tag=SpawnGreenSnowman] at @s run summon armor_stand ~ ~ ~ {Silent:1b,NoGravity:0b,Team:"Green",ArmorItems:[{},{},{},{id:"golden_hoe",Count:1b,tag:{Unbreakable:1b,CustomModelData:12}}],Tags:["GreenSnowman","Snowman","NewSnowman"],Invisible:1b,Invulnerable:1b,DisabledSlots:2096896,Rotation:[90f,0f]}
