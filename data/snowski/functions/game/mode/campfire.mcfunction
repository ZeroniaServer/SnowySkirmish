...
execute as @a[team=Green,tag=Knocked,scores={nnhealth=..1}] at @s if entity @e[tag=GreenCampfire,distance=..3] run tellraw @a ["",{"selector":"@s","color":"green"},{"text":" was revived! ","color":"dark_aqua"},{"text":"Red ","color":"red"},{"text":"lost ","color":"dark_aqua"},{"text":"2 ","color":"gold"},{"text":"points!","color":"dark_aqua"}]
...
execute as @a[team=Red,tag=Knocked,scores={nnhealth=..1}] at @s if entity @e[tag=RedCampfire,distance=..3] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" was revived! ","color":"dark_aqua"},{"text":"Green ","color":"green"},{"text":"lost ","color":"dark_aqua"},{"text":"2 ","color":"gold"},{"text":"points!","color":"dark_aqua"}]
