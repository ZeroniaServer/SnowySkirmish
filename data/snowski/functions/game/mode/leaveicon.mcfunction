...
execute as @a[team=!Lobby,team=!Spectator,tag=YouSure,nbt=!{Inventory:[{Slot:22b,id:"minecraft:diamond_hoe",tag:{ExitIcon:1b}}]}] run scoreboard players set @s leavegame 1
