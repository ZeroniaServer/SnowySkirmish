execute unless score $gamestate CmdData matches 2 run execute as @s[tag=!Knocked,tag=!InVoid] run tellraw @a ["",{"selector":"@s","color":"green"},{"text":" fell out of the map! ","color":"dark_aqua"},{"text":"Red ","color":"red"},{"text":"+4 ","color":"gold"}]
execute unless score $gamestate CmdData matches 2 run execute as @s[tag=!InVoid] run scoreboard players add @s deathcollect 1
execute unless score $gamestate CmdData matches 2 run execute as @s[tag=Knocked,tag=!InVoid] run tellraw @a ["",{"selector":"@s","color":"green"},{"text":" fell out of the map while being knocked out! ","color":"dark_aqua"},{"text":"Red ","color":"red"},{"text":"+6","color":"gold"}]
