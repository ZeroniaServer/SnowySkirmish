...
execute unless score $gamestate CmdData matches 2 as @s[tag=Knocked,tag=!InVoid] unless entity @a[predicate=snowski:matches_uuid] unless entity @e[tag=sbfound] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" fell out of the map while being knocked out! ","color":"dark_aqua"},{"text":"Green ","color":"green"},{"text":"+6","color":"gold"}]
execute unless score $gamestate CmdData matches 2 as @s[tag=Knocked,tag=!InVoid] if entity @a[predicate=snowski:matches_uuid] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" was knocked out of the map by ","color":"dark_aqua"},{"selector":"@a[team=Green,limit=1,predicate=snowski:matches_uuid]"},{"text":" while being knocked out! ","color":"dark_aqua"},{"text":"Green ","color":"green"},{"text":"+4 ","color":"gold"}]
execute unless score $gamestate CmdData matches 2 as @s[tag=Knocked,tag=!InVoid] if entity @e[tag=sbfound] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" was knocked out of the map by ","color":"dark_aqua"},{"selector":"@e[type=armor_stand,tag=Snowman,limit=1,tag=sbfound]"},{"text":" while being knocked out! ","color":"dark_aqua"},{"text":"Green ","color":"green"},{"text":"+4 ","color":"gold"}]
