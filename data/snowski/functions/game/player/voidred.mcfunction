execute unless score $gamestate CmdData matches 1 run execute as @s[tag=!Knocked,tag=!InVoid] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" fell out of the map! ","color":"dark_aqua"},{"text":"+4","color":"gold"}]
execute unless score $gamestate CmdData matches 1 run execute as @s[tag=Knocked,tag=!InVoid] run tellraw @a ["",{"selector":"@s","color":"red"},{"text":" fell out of the map while being knocked out! ","color":"dark_aqua"},{"text":"+6","color":"gold"}]
...
execute unless score $gamestate CmdData matches 1 run execute as @s[tag=!InVoid,tag=Knocked] run scoreboard players add $GreenGifts CmdData 6
