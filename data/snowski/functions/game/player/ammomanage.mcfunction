...
execute as @s[scores={snowballammo=5}] run item replace entity @s hotbar.4 with snowball{HideFlags:8,CanDestroy:["minecraft:clay"],CustomModelData:1,display:{Name:'[{"text":"Snowball","italic":false,"color":"dark_aqua","underlined":true}]'}} 5
