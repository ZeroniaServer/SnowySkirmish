...
execute unless entity @s[tag=SleighOffGround] at @s unless entity @p[predicate=snowski:in_sleigh,nbt={Motion:[0.0d,0.0d,0.0d]}] run particle minecraft:block{block_state:"minecraft:snow"} ~ ~ ~ 0.1 0 0.1 0.1 5 force
